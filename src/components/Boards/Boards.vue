   ...
   <v-container class="v-container">
       <v-container text-xs-center>
        <v-layout justify-center>
         <v-flex d-inline-flex class="search_space"  x12 sm10 md8 lg10 offset-sm1 offset-md2>
          <input class="search-wrapper" type="text" v-model="search" placeholder="검색" />
          <v-flex class="fdfd"><button flat class="search-btn"></button></v-flex>
         </v-flex>
         <v-flex >
         </v-flex>
         </v-layout>
                    ...
                    <v-container fluid>
                        ...
                        <v-card-title primary-title>
                            <v-flex class="v-card-content">
                                <h2>{{board.title}}</h2> <!--class="headline mb-0"-->
